...
import { setCheckedPartner } from "../../../../../Redux/Slices/orderCheckedPartner";

function SelectPartnerTable(props) {
  ...
  const extractIdFromSelectedRows = () => {
    ...
    dispatch(setCheckedPartner(selectedId));
  };
...
export default SelectPartnerTable;
